...
public interface IInputProvider
{
    ...
    IEnumerable<T> MultiSelect<T>(string prompt, T[] choices, bool required, T[]? selectedValues = null, Func<T, string>? converter = null) where T : notnull;
...
public class ConsoleInputProvider(IAnsiConsole console) : IInputProvider
{
    ...
    public IEnumerable<T> MultiSelect<T>(string prompt, T[] choices, bool required, T[]? selectedValues = null, Func<T, string>? converter = null)
        where T : notnull
    {
