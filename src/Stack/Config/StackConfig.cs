...
public class FileStackConfig(string? configDirectory = null) : IStackConfig
{
    ...
    private static StackV2 MapToV2Format(Stack stack)
    {
        ...
        return new StackV2(stack.Name.ToString(), stack.RemoteUri, stack.SourceBranch, branchesV2);
    }
    ...
    {
        return new StackV1(stack.Name.ToString(), stack.RemoteUri, stack.SourceBranch, stack.AllBranchNames);
    }
