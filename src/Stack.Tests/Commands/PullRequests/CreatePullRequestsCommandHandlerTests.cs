...
{StackConstants.StackMarkerEnd}";
    ...
    [Fact]
    public async Task WhenPullRequestLabelsExistsForStack_DoesNotAskForThemAgain_LabelsAreAppliedToCreatedPullRequests()
    {
        // Arrange
        var sourceBranch = Some.BranchName();
        var branch1 = Some.BranchName();
...
{StackConstants.StackMarkerEnd}";
    ...
    [Fact]
    public async Task WhenPullRequestLabelsDoNotExistForStack_AsksForLabels_AndAppliesToCreatedPullRequests()
    {
        // Arrange
        var sourceBranch = Some.BranchName();
        var branch1 = Some.BranchName();
