...
public class StackActionsTests(ITestOutputHelper testOutputHelper)
{
    ...
    [Fact]
    public void PullChanges_WhenChangesExistOnCurrentBranch_PullsChangesCorrectly()
    {
        // Arrange
        var sourceBranch = Some.BranchName();
    ...
    [Fact]
    public void PullChanges_WhenChangesExistOnNonCurrentBranch_PullsChangesCorrectly()
    {
        // Arrange
        var sourceBranch = Some.BranchName();
        var featureBranch = Some.BranchName();
